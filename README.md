...
[data product 7: Exámenes PCR por región](output/producto7): 2 archivos con valores separados por coma (csv), el primero corresponde al reporte de exámenes PCR realizados, y el segundo, a la serie de tiempo de los datos anteriores, por región. 
...
por coma (csv), el primero corresponde a el cumulativo de inicio de sintomas para casos confirmados por semana epidemiológica, el segundo a la serie de tiempo de los datos anteriores y el tercero indica las fechas que marcan los inicios y términos de cada semana semana epidemiológica. **Nota: estos datos son provisorios a la fecha del ultimo reporte, pues se van actualizando a medida que se confirman los datos confirman.**
