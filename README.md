...
[Data Product 33 - Índices Movilidad Nacional a nivel comunal](output/producto33): Set de 9 archivos en formato csv que dan cuenta de índices de movilidad construidos con los datos de la red de telefonía móvil para viajes dentro de una comuna, viajes con origen dentro de la comuna y destino afuera de la comuna (y su recíproco). [Ver Más](output/producto33)
